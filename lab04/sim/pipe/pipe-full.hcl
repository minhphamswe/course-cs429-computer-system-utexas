...
#
# Implemented the IIADDL instruction.
# Implementation detais are similar to those in lab 4.
# Details are as follow:
#     Add IIADDL to the list of valid instructions
#     Add IIADDL to the list of instructions that require a REGID byte
#     Add IIADDL to the list of instructions that require a constant word
#     Use D_rB as the B source for IIADDL
#     Use D_rB as the E destination for IIADDL
#     Use E_valC as the input A to ALU for IIADL
#     Use E_valB as the input B to ALU for IIADL
#     Set the condition code with IIADDL
#
